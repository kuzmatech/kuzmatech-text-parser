...
var KZMPARSER = ((options = defaults) => {
    ...
    const bbcode = isBrowser ? window.XBBCODE : require('../dependencies/xbbcode');
    const bbcodext = isBrowser ? window.KZMBBCODEEXTENSIONS() : require('../dependencies/xbbcode-extension')()
